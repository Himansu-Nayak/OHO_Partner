  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ background: "#EEF3FB" }}>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 py-4 pb-24 space-y-4">
        ...
        {/* Incentive Banner (Gamified Progress) */}
    ...
    <div className="w-full h-full flex flex-col" style={{ background: "#EEF3FB" }}>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 py-4 pb-24 space-y-4">
        ...
        <button 
          ...
          className="w-full py-4 rounded-2xl font-700 text-base shadow-lg transition-all relative overflow-hidden" 
          style={{ background: cashoutStatus === "success" ? "#16A34A" : "#2563EB", color: "white" }}
        >
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Stream driver location periodically
